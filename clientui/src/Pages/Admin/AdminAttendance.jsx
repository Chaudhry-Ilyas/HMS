          ...
          {attendancesArray.map((attendance) => (
            <StyledTableRow >
             <StyledTableCell >{attendance.userId}</StyledTableCell>
              ...
              <StyledTableCell ><EditIcon onClick={() => handleEdit(attendance._id)}/></StyledTableCell>
              <StyledTableCell ><DeleteIcon onClick={() => delAttendance(attendance?._id)}/></StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
